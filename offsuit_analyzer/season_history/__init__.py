...
get_event_dates_to_record = get_board_wipe_dates_to_record
get_observed_event_dates = get_observed_board_wipe_dates
...
__all__ = [
    ...
    "get_board_wipe_dates_to_record",
    "get_observed_board_wipe_dates",
    "get_event_dates_to_record",
    "get_observed_event_dates",
]
